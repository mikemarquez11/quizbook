 ...
 */
    ...
    /**
     * Shortcode 
     * Usage: [quizbook-exam questions="" orden="" id=""]
     */
    public function render_form_exam($atts) {
        // Read Shortcode ID to render Exam
        $exam_ID = (int) $atts['id'];
